...
def correlation_matrix(df, cols):
    ...
    fig = sns.heatmap(df[cols].corr(), annot=True, linewidths=0.7, annot_kws={'size': 15}, linecolor='w', cmap='RdBu')
    plt.show(block=True)
...
# Implementation of Rare Encoder
...
def create_pca_df(X, y):
    ...
    pca_df = pd.DataFrame(data=pca_fit, columns=['PC1', 'PC2', 'PC3', 'PC4', 'PC5', 'PC6', 'PC7', 'PC8', 'PC9', 'PC10'])
